    ...
    <div className="mx-auto max-w-7xl pb-10">
      <section className="rise-in relative overflow-hidden rounded-2xl border border-[#dba71d]/45 bg-[#14150f] px-6 py-7 md:px-9 md:py-9">
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div><div className="mb-3 flex items-center gap-2 text-[#e2b540]"><Crosshair className="h-4 w-4" /><span className="text-[11px] font-bold uppercase tracking-[0.17em]">Bashfx VIP Gold Room / XAUUSD M5</span></div><h1 className="font-display text-5xl tracking-wide text-white md:text-6xl">YOUR WEEK, IN FOCUS.</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-[#b5b2a5]">{isAuthenticated ? `Welcome back${user?.name ? `, ${user.name}` : ""}. Record each dated XAUUSD trade, review your weekly ledger, then generate a polished Gold Room report.` : "Sign in to keep your dated XAUUSD journal and generated performance summaries private."}</p></div>
