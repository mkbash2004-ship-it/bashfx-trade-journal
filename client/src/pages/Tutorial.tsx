    ...
    <div className="mx-auto max-w-7xl pb-12">
      <section className="rise-in overflow-hidden rounded-2xl border border-[#dba71d]/45 bg-[radial-gradient(circle_at_85%_10%,rgba(219,167,29,.2),transparent_28%),linear-gradient(145deg,#16170f,#0e100c_72%)] px-6 py-8 md:px-9 md:py-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-6 text-[#b7b4a8]">Watch the complete touch-guided walkthrough to record your XAUUSD trades, review the weekly log, create your branded result image, and manage private reminders.</p>
        </div>
      </section>
